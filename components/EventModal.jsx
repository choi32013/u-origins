// EventModal.jsx — 사건 클릭 시 인포그래픽 모달
// 요약 + 인과관계 그래프 + 좋아요/싫어요 + 이슈 제기 + 자세히 보기

const EventModal = ({ event, data, onClose, onSelectEvent }) => {
  const [reaction, setReaction] = React.useState(null); // 'like' | 'dislike' | null
    ...
    >
      ...
      >
        ...
        <div style={{ padding: '36px 36px 28px', borderRight: '1px solid #eee' }}>
          ...
          <h2 style={{
            margin: '0 0 16px',
            fontSize: 34, fontWeight: 700, color: '#1a1815',
          ...
          <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 20 }}>
            {event.tags && event.tags.map(t => (
              <span key={t} style={{
                ...
                borderRadius: 10, background: '#f4f1e8', color: '#6b6a63',
                letterSpacing: 0.2,
              }}>{t}</span>
            ))}
          </div>
          ...
          {/* 요약 */}
          <p style={{
            fontSize: 15, lineHeight: 1.7, color: '#3a352d',
            marginBottom: 28,
          }}>
            {event.summary}
          </p>
          ...
          {(causes.length > 0 || effects.length > 0) && (
            <div style={{ marginBottom: 24 }}>
              <div style={{
                fontSize: 11, letterSpacing: 0.8, textTransform: 'uppercase',
                color: '#8a8578', fontWeight: 600, marginBottom: 14,
              }}>
                인과관계
              </div>
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                  {causes.length === 0 && (
                    <div style={{ fontSize: 12, color: '#b8b2a0', fontStyle: 'italic', padding: '8px 0' }}>
                      —
                    </div>
                  )}
                  {causes.map(c => (
                    <button key={c.id}
                      ...
                      style={{
                        textAlign: 'left', border: '1px solid #e6e1d3',
                        background: '#fafaf7', padding: '10px 12px', borderRadius: 6,
                        cursor: 'pointer', fontSize: 13, color: '#3a352d',
                        fontFamily: 'inherit',
                        transition: 'all 0.15s',
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = '#fff';
                        e.currentTarget.style.borderColor = '#c25b3f';
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = '#fafaf7';
                        e.currentTarget.style.borderColor = '#e6e1d3';
                      }}
                    >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                  ...
                  <div style={{
                    fontSize: 11, color: '#c25b3f', fontWeight: 600,
                    padding: '4px 10px', borderRadius: 4, background: '#fcf5f2',
                    letterSpacing: 0.3, textAlign: 'center', width: 80,
                  }}>
        ...
        <div style={{ padding: '36px 28px', background: '#fafaf7', display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${reaction === 'like' ? '#2a251f' : '#d9d4c6'}`,
                  background: reaction === 'like' ? '#2a251f' : '#fff',
                  color: reaction === 'like' ? '#fff' : '#3a352d',
              ...
              <button
                ...
                style={{
                  flex: 1, padding: '10px', borderRadius: 6,
                  border: `1px solid ${reaction === 'dislike' ? '#2a251f' : '#d9d4c6'}`,
                  background: reaction === 'dislike' ? '#2a251f' : '#fff',
                  color: reaction === 'dislike' ? '#fff' : '#3a352d',
                  cursor: 'pointer', fontSize: 13, fontFamily: 'inherit',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6,
                }}
              >
            ...
            {!issueOpen ? (
              <button
                ...
                style={{
                  ...
                  border: '1px dashed #b8b2a0', background: 'transparent',
                  color: '#3a352d', cursor: 'pointer', fontSize: 13, fontFamily: 'inherit',
                }}
              >
                이슈 제기
              </button>
              ...
              <div style={{
                padding: '12px', background: '#e8f0e5',
                color: '#3a5a30', fontSize: 13, borderRadius: 6, textAlign: 'center',
              }}>
                ✓ 관리자에게 전달되었습니다
              </div>
            ) : (
                ...
                <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
                  <button
                    ...
                    style={{
                      ...
                      border: '1px solid #d9d4c6', background: '#fff',
                  ...
                  <button
                    ...
                    style={{
                      flex: 1, padding: '8px', borderRadius: 6,
                      border: 'none', background: '#c25b3f', color: '#fff',
          ...
          <button
            ...
            style={{
              ...
              color: '#8a8578', cursor: 'pointer', fontSize: 12, fontFamily: 'inherit',
            }}
          >
            닫기 (Esc)
          </button>
